...
| **TzdTools CPU NTT (`--experimental-compute`)** | **10.64 ms** | **54.02 ms** (纯内核) | **13.67 ms** | **175.41 ms** (0.175 秒) | **3.1x (纯算超越 GMP 2.07x)** |
...
> - **无 GPU 纯 CPU 环境？**：详情请参阅专文 [CPU NTT 极限计算引擎底层剖析 (--experimental-compute)](CPU-NTT-BigInt-zh.md)，了解如何在纯 CPU 环境下以 AVX2 向量化与 4-Step 矩阵转置实现 175 ms 极速乘法。
